...
一个面向毕业设计场景的全栈视频数据分析系统，覆盖“登录隔离、双身份账号、数据采集、文本/文件智能入库、标准化清洗、可视化分析、报告导出”完整链路。
...
- 双身份账号：支持“观众”与“内容创作者”两类角色注册
- 数据管理闭环：支持 URL 采集、文本/文件入库、清空数据、错误反馈
- 标准化入库：对不同来源字段做统一映射，并记录低质量/拒绝数据
- 数据分析丰富：热门视频、分类统计、互动效率、用户画像、平台筛选、创作者同行对标
...
### 1.1 创作者中心
- 创作者可注册时填写创作者名称、主运营平台、主打方向
- 登录后优先进入创作者中心
- 支持查看自己的作品总览、代表作品、内容方向分布
- 支持同行作者对标、平均播放比较、互动效率比较与策略建议
...
一键脚本已取消运行时密码输入，数据库账号密码通过环境变量读取（不在仓库保存明文密码）：
...
也可以直接注册新账号进入自己的数据空间。若选择“内容创作者”身份，登录后会直接进入创作者中心。
